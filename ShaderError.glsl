...
void main(void) {
    ...
    { 
        x_color.rgb = clamp(x_color.rgb, vec3(0.0), vec3(1.0));
     }
...
// -------------
// shade-style-custom:expansion-1363272876
// created 2023-07-30T14:45:00.347626
/*
ERROR: 0:85: Use of undeclared identifier 'x_color'
ERROR: 0:85: Use of undeclared identifier 'x_color'
*/
